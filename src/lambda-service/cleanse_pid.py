import pandas as pa
from functions import remove_personal_info, clean_products, return_item_tuples, write_into_dataframe, return_start_id
...
orders_df = remove_personal_info("/home/mrfox/Desktop/projekt/team-3-project/src/lambda-service/isle_of_wight")
